...
class Map:
    def __init__(self, screen: Screen, controller: Controller, sql: SQL):
        ...
        self.name = self.sql.select("map", ["name"], f"id_map='{self.current_map.name}'")[0][0]
